...
export default function TableByMonthYear() {
  ...
  const getByMonthYear = async (year, month) => {
    const res = await MainService.finByMonthYear(year, month);
    setRows(res.data);
  };
    ...
    <DashboardLayout>
      ...
      <Grid>
        <form
          onSubmit={(e) => {
            e.preventDefault();
            getByMonthYear(yearState, monthState);
          }}
        >
          <Typography>Introduce el año y mes de los datos</Typography>
